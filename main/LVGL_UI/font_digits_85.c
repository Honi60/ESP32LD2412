 ...
 * Size: 85 px
 * Bpp: 4
 * Opts: --font components/lvgl__lvgl/scripts/built_in_font/Montserrat-Medium.ttf -r 0x2D,0x2E,0x30-0x39 --size 85 --bpp 4 --no-compress --format lvgl --lv-include lvgl.h -o main/LVGL_UI/font_digits_85.c
 ******************************************************************************/
...
#ifndef FONT_DIGITS_85
#define FONT_DIGITS_85 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 521, .box_w = 24, .box_h = 8, .ofs_x = 4, .ofs_y = 20},
    {.bitmap_index = 96, .adv_w = 309, .box_w = 13, .box_h = 13, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 181, .adv_w = 907, .box_w = 49, .box_h = 62, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 1700, .adv_w = 503, .box_w = 23, .box_h = 60, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2390, .adv_w = 781, .box_w = 45, .box_h = 61, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3763, .adv_w = 778, .box_w = 45, .box_h = 61, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 5136, .adv_w = 910, .box_w = 53, .box_h = 60, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 6726, .adv_w = 781, .box_w = 45, .box_h = 61, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 8099, .adv_w = 839, .box_w = 47, .box_h = 62, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 9556, .adv_w = 813, .box_w = 46, .box_h = 60, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 10936, .adv_w = 876, .box_w = 48, .box_h = 62, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 12424, .adv_w = 839, .box_w = 47, .box_h = 62, .ofs_x = 2, .ofs_y = -1}
};
...
static const int8_t kern_class_values[] =
{
    ...
    -14, 0, 0, -10, 0, -16, -18, 14,
    14, -12, 0, -18, 14, 0, 10, -16,
    0, -4, -4, -14, 0, 0, -10, 0,
    0, -10, 14, -4, 0, 0, 0, -26,
    0, -4, 0, 0, 0, 0, 0, 0,
    -7, -7, 0, -14, -16, 0, 0, 14,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_digits_85 = {
#else
lv_font_t font_digits_85 = {
#endif
